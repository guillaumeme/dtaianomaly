...
```
cd existing_repo
git remote add origin https://gitlab.kuleuven.be/u0143709/time-series-anomaly-detection.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.kuleuven.be/u0143709/time-series-anomaly-detection/-/settings/integrations)
